...
namespace GoogleAnalytics
{
    public sealed class PlatformInfoProvider : IPlatformInfoProvider
    {
        ...
        public string GetUserAgent()
        {
            ...
            return string.Format("Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; Trident/6.0{0}; {1}; {2})", hasTouch ? "; Touch" : "", sysInfo.SystemManufacturer, sysInfo.SystemProductName);
        }
    }
}
