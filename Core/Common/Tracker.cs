...
namespace GoogleAnalytics.Core
{
    public sealed class Tracker
    {
        ...
        public Tracker(string propertyId, IPlatformInfoProvider platformInfoProvider, IServiceManager serviceManager)
        {
            ...
            if (string.IsNullOrEmpty(serviceManager.UserAgent)) serviceManager.UserAgent = platformInfoProvider.GetUserAgent();
        ...
        /// <summary>
        /// Optional. This is intended to be a known identifier for a user provided by the site owner/tracking library user. It may not itself be PII (personally identifiable information). The value should never be persisted in GA cookies or other Analytics provided storage.
        /// </summary>
