...
"%DEVENV%" /build "Release|ARM" GoogleAnalytics.VS2015.sln
"%DEVENV%" /build "Release|Win32" GoogleAnalytics.VS2015.sln
"%DEVENV%" /build "Release|x64" GoogleAnalytics.VS2015.sln
...
copy "..\..\Release\GoogleAnalytics.Native.Win10\GoogleAnalytics.winmd"				"References\CommonConfiguration\neutral\"
copy "..\..\Release\GoogleAnalytics.Native.Win10\GoogleAnalytics.pri"				"Redist\CommonConfiguration\neutral\"
copy "..\..\ARM\Release\GoogleAnalytics.Native.Win10\GoogleAnalytics.Native.dll"	"Redist\CommonConfiguration\ARM\"
copy "..\..\Release\GoogleAnalytics.Native.Win10\GoogleAnalytics.Native.dll"		"Redist\CommonConfiguration\x86\"

"%ZIP%" a ..\GoogleAnalyticsSDK.Win10.zip "*"
...
move GoogleAnalyticsSDK.Win10.zip Master\GoogleAnalyticsSDK.Win10.vsix
